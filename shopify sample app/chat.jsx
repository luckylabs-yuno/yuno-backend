...
async function handleChatSession({
  ...
  const shopDomain = "https://suta.in";
  const shopId = "suta.in"; // Use a dummy or real shop ID as needed
  const customerMcpEndpoint = "https://suta.in/account/customer/api/mcp";
  const mcpClient = new MCPClient(
    shopDomain,
    conversationId,
    shopId,
